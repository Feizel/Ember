...
@MainActor
class EmberStreakManager: ObservableObject {
    static let shared = EmberStreakManager()
    ...
    private func checkStreakMilestones() {
        ...
        for milestone in milestones {
            if currentStreak >= milestone.days && !streakMilestones.contains(where: { $0.days == milestone.days }) {
                ...
                NotificationCenter.default.post(name: .streakMilestoneAchieved, object: milestone)
            }
        }
    }
    ...
    func getStreakMessage() -> String {
        ...
        case 2...6: return "Building momentum! \(7 - currentStreak) days to Bronze Heart"
        case 7...29: return "Bronze achieved! \(30 - currentStreak) days to Silver Heart"
        case 30...99: return "Silver achieved! \(100 - currentStreak) days to Gold Heart"
        case 100...364: return "Gold achieved! \(365 - currentStreak) days to Diamond Heart"
        default: return "Diamond Heart achieved! You're unstoppable!"
        }
    }
}
