...
class OnboardingManager: ObservableObject {
    ...
    init() {
        // Reset onboarding for testing - remove this line for production
        userDefaults.set(false, forKey: "onboardingCompleted")
...
enum RelationshipGoal: String, CaseIterable, Identifiable {
    ...
    var color: Color {
        switch self {
        case .dailyConnection: return ColorPalette.sensualRed
        case .intimacy: return ColorPalette.passionRed
        case .communication: return ColorPalette.goldenYellow
        case .playfulness: return ColorPalette.sunsetOrange
        case .support: return ColorPalette.warmYellow
        }
    }
}
