...
struct TouchRecord: Identifiable {
    ...
    var gestureIcon: String {
        switch gestureType {
        case "Squeeze Hand": return "hand.raised.fill"
        case "Forehead Kiss": return "face.smiling"
        case "Hug": return "figure.2.arms.open"
        case "Shoulder Tap": return "hand.tap.fill"
        case "Heart Trace": return "heart.fill"
